        ...
        serviceScope.launch {
            try {
                ...
                while (usageEvents.hasNextEvent()) {
                    ...
                    if (eventPackageName == null || eventPackageName.startsWith(applicationContext.packageName)) {
                        continue
                    }
                ...
                when (event.eventType) {
                    UsageEvents.Event.ACTIVITY_RESUMED, 1, 19 -> {
                        ...
                        if (currentForegroundPackage != null && currentForegroundPackage != eventPackageName) {
                            ...
                            if (!(eventPackageName.startsWith(applicationContext.packageName) && !AppLifecycleObserver.isActivityInForeground.value)) {
